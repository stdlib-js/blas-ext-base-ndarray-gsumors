...
```javascript
var gsumors= require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-ndarray-gsumors' );
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-ndarray-gsumors/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/blas-ext-base-ndarray-gsumors/actions/workflows/test.yml?query=branch:v0.1.0
